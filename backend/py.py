...
model_path = '/Users/morteanualexandru/Downloads/best.tflite'  # Replace with your model path
label_path = '/Users/morteanualexandru/Desktop/labelmap.txt'  # Replace with your label map path
